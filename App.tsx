             ...
             <button 
              onClick={() => {
                if(confirm("모든 데이터를 초기화하시겠습니까?")) {
                  localStorage.removeItem('gb_announcements');
                  window.location.reload();
                }
              }} 
              className="text-xs text-slate-400 hover:text-indigo-600 font-bold tracking-tighter uppercase transition-colors"
             >
               Reset
             </button>
          </div>
          ...
          <form onSubmit={handlePost} className="space-y-4">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full rounded-xl border-slate-200 bg-slate-50 text-sm font-medium focus:ring-indigo-500 focus:border-indigo-500 py-3 px-4"
                required
              />
            </div>
            <div>
              ...
              <textarea 
                ...
                className="w-full rounded-xl border-slate-200 bg-slate-50 text-sm focus:ring-indigo-500 focus:border-indigo-500 resize-none py-3 px-4"
                required
              />
            </div>
